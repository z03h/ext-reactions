.. dpy ext reactions documentation master file, created by
   sphinx-quickstart on Tue Jan 12 02:59:06 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Documentation for ext.reactions
=============================================

Extension for discord.py that adds reaction commands.
Kinda pepega because I wrote it, but it works.
...
Anyways, heres a huge wall of example code:
